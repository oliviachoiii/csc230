...
clear_index:
	ldi r18, 0
	ldi XL, LOW(CURRENT_CHARSET_INDEX)	;partD
...
clear_loop:		;loop 16 times (16 byte)
	st X+, r18
	st Y+, r19
	dec r25
	brne clear_loop
...
store_length:	;get the length of string and store in LENGTH
	sts LENGTH, r24
...
hexdigit_on:
	...
	;add YL, r17	<< I think this should be working????
	;adc YH, r23
